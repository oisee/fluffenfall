...
var FileFormPSG = React.createClass({
  ...
  getInitialState: function() {
    return {data_uri: null, uploaded: false};
  },
  ...
  handleUpload: function(upload) {
    this.setState({data_uri: upload.target.result, uploaded: true});
  ...
  handleFile: function(e) {
    ...
    if (typeof file !== "undefined") {
      ...
      self.setState({data_uri: null, uploaded: false});
      this.props.onUpdate(false);
    };
  },

  render: function() {
    var panelStyle = this.state.uploaded
      ? "panel panel-success"
      : "panel panel-default";
    return (
